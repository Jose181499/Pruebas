...
function renderCotizacionFormContent(isEdit) {
    ...
    <!-- ============================================================ -->
    <!-- 1. DATOS DEL CLIENTE - COMPACTO (misma altura que la 2) -->
    <!-- ============================================================ -->
    <div class="create-panel client-card" style="background:#FFFFFF;border:1px solid #E5E7EB;border-radius:10px;box-shadow:0 2px 8px rgba(15,23,42,.04);overflow:hidden;display:flex;flex-direction:column;height:100%;">
        ...
        <div class="body" style="padding:6px 8px;flex:1;display:flex;flex-direction:column;justify-content:space-between;">
            <div>
                ...
                <!-- Dirección Fiscal -->
                <div style="display:grid;grid-template-columns:1fr;gap:3px;margin-bottom:2px;">
                    <div class="form-field">
            ...
            <!-- Guardar - alineado con Nota Comercial -->
            <div style="display:flex;flex-direction:column;align-items:center;gap:1px;margin-top:auto;padding-top:4px;border-top:1px solid #F1F5F9;">
                <button onclick="saveClientFromQuote()" style="width:100%;height:24px;border-radius:5px;font-size:9px;font-weight:950;border:0;background:#16A34A;color:#fff;cursor:pointer;">💾 Guardar / Actualizar</button>
    ...
    <!-- 3. RESUMEN - COMPACTO -->
    <!-- ============================================================ -->
    <div class="create-panel summary-card" style="background:linear-gradient(180deg, #FFFFFF 0%, #FBFCFE 100%);border:1px solid #E5E7EB;border-radius:10px;box-shadow:0 2px 8px rgba(15,23,42,.04);overflow:hidden;display:flex;flex-direction:column;height:100%;">
        <h3 style="padding:4px 10px;border-bottom:1px solid #E5E7EB;font-size:11px;font-weight:1000;color:#0F172A;background:#FAFBFC;display:flex;align-items:center;gap:5px;margin:0;flex-shrink:0;">
            <span style="color:#EF233C;font-weight:1000;">3.</span> 
            <span style="color:#EF233C;font-weight:1000;">Resumen</span>
        </h3>
        <div class="body" style="padding:6px 8px;flex:1;display:flex;flex-direction:column;justify-content:center;">
