...
def guardar_pc_db(data):
    ...
    try:
        ...
        print(f"📝 Parámetros: {params[:10]}...")  # Mostrar primeros 10 parámetros
        ...
        if result:
            ...
            if cotizacion_id:
                try:
                    ...
                    print(f"✅ Cotización {cotizacion_id} actualizada a 'Aceptada por Cliente'")
                except Exception as e:
                    print(f"⚠️ No se pudo actualizar estado de cotización: {e}")
            
            print(f"✅ PC guardado exitosamente: {result['numero']}")
            
            return jsonify({
                'success': True, 
                'message': f'PC guardado correctamente: {result["numero"]}',
                'data': result
            })
